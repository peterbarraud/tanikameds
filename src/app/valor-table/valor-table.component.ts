...
@Component({
  selector: 'app-valor-table',
  templateUrl: './valor-table.component.html',
  styleUrls: ['./valor-table.component.css']
})
export class ValorTableComponent implements OnChanges {
